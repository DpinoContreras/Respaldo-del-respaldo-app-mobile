...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__upload_files__ = __webpack_require__(320);
...
var UploadFilesPage = /** @class */ (function () {
    function UploadFilesPage(navCtrl, viewCtrl, formBuilder, toastCtrl, types, course, doc) {
        var _this = this;
    ...
    UploadFilesPage.prototype.done = function () {
        ...
        this.doc.addDocument(this.form.value).subscribe(function (res) {
